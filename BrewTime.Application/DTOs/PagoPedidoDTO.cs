...
namespace BrewTime.Application.DTOs
{
    public class PagoPedidoDTO
    {
        [Range(
            1,
            int.MaxValue,
            ErrorMessage = "El pedido indicado no es válido.")]
        public int PedidoId { get; set; }

       
        //Se muestra en la pantalla. El servicio debe consultar nuevamente el total en la BD.
        ...
        [Range(
            1,
            int.MaxValue,
            ErrorMessage = "Debe seleccionar un método de pago válido.")]
        ...
        [StringLength(
            100,
            ErrorMessage = "El nombre del titular no puede superar los 100 caracteres.")]
        [Display(Name = "Nombre del titular")]
        public string? NombreTitular { get; set; }

        [RegularExpression(
            @"^\d{13,19}$",
            ErrorMessage = "El número de tarjeta debe contener entre 13 y 19 dígitos.")]
        ...
        [RegularExpression(
            @"^(0[1-9]|1[0-2])\/\d{2}$",
            ErrorMessage = "La fecha de vencimiento debe utilizar el formato MM/AA.")]
        [Display(Name = "Fecha de vencimiento")]
        public string? FechaVencimiento { get; set; }

        [RegularExpression(
            @"^\d{3,4}$",
            ErrorMessage = "El código de seguridad debe contener 3 o 4 dígitos.")]
        [DataType(DataType.Password)]
        ...
        [Range(
            ...
            "0.01",
            "99999999.99",
            ErrorMessage = "El monto recibido debe ser mayor a cero.")]
        ...
        // Referencia de SINPE o transferencia
        [StringLength(
            100,
        ...
        [StringLength(
            100,
            ErrorMessage = "El nombre del banco no puede superar los 100 caracteres")]
        [Display(Name = "Banco de origen")]
