...
namespace BrewTime.Web.Controllers
{
    ...
    public class PedidoController : Controller
    {
        ...
        private async Task RecargarRegistroAsync(PedidoCreateDTO dto)
        {
           ...
           //se vuelve a consultar el carrito y toda la informaci�n proveniente de la base de datos.
            var reconstruido = await _servicePedido.PrepararRegistroAsync(UsuarioActual, RolActual);

            //conservamos �nicamente las observaciones escritas por el usuario.
            var observaciones =
                (dto.Detalles ??
            ...
            //si el usuario es cliente, sus datos se establecen autom�ticamente
            ...
            //se vuelve a consultar el costo real del m�todo seleccionado
        ...
        private async Task<IActionResult> RecargarPagoAsync(PagoPedidoDTO dto)
        {
            try
            {
                ...
                //conserva los datos introducidos por el usuario, mientras que el detalle y los m�todos de pago vuelven a obtenerse desde la base de datos
                model.Pago = dto;
